...
- SQL: Use for numerical, aggregate, ranking, counting, comparison, or exact lookup queries. Examples: "top 10 students by SGPA", "average marks in semester 4", "how many students failed", "what was Aakash's SGPA", "compare semester 1 vs 6", "count of students with back papers". Also use SQL for short ambiguous follow-up queries that reference only a filter value with no descriptive intent (e.g. "what about semester 3", "semester 4?", "what about CSE").
